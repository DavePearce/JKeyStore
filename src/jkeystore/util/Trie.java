...
/**
 * <p>
 * Provides a standard implementation of the Key and Filter interfaces. It
 * employs the <i>flyweight pattern</i> to ensure every Key can only ever
 * correspond to a single instance of of Trie. That, it ensures that any two
 * instances which represent the same Key are, in fact, the same instance.
 * </p>
 * <p>
 ...
 *
 */
public final class Trie implements Key {
	...
	public int compareTo(final Key o) {
		if(o instanceof Trie) {
			...
			throw new IllegalArgumentException("Attempting to compare Trie with some other Key");
		}
	}
	...
	@Override
	public Trie append(final Key id) {
		Trie r = this;
	 ...
	 * @return
	 */
	public static Trie fromString(Key id) {
	 ...
	 * @return
	 */
	public static Trie fromString(Key id, String str) {
		if(id instanceof Trie) {
	...
	private boolean match(Key id, int idIndex, int myIndex, boolean submatch) {
		int mySize = depth + 1;
